...
# Crear una copia del problema con comprobación hacia adelante
...
print("Soluciones sin comprobación hacia adelante:")
for solution in solutions:
    print(solution)

print("\nSoluciones con comprobación hacia adelante:")
